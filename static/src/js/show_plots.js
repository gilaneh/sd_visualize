...
//import Plotly from 'km_data.plotly.min'
//import { Plotly } from "sd_visualize.plotly.min";
...
//                var localeReady = loadJS(url);
    ...
    viewRegistry.add('km_data_data_view', KmDataViewFormView);
    export default {
